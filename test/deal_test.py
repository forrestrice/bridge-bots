...
from deal.deal import PlayerHand, Card, Deal
...
class TestDeal(unittest.TestCase):
    ...
    def test_constructor_sorts(self):
        ...
        self.assertEqual([Card(Suit.CLUBS, Rank.ACE), Card(Suit.CLUBS, Rank.KING), Card(Suit.CLUBS, Rank.TWO)],
                         ph.cards[0:3])

    def test_deal_from_acbl_handrecord(self):
        handrecord = '{"box_number":"03151000","board_number":36,' \
        ...
        expected_north = PlayerHand.from_string_lists(['K', '8', '2'], ['6', '2'], ['A', 'Q', '10', '9', '3'],
                                                      ['10', '6', '2'])
    ...
    def test_deal_from_handrecord_with_void(self):
        handrecord = '{"box_number": "11091800", "board_number": 6, ' \
